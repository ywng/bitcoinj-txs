...
public class ScriptTests {
    ...
    @Test
    public void testGenerateVanityAddressMainNet() {
        //downloadBlockchain();
        try (ScriptTransaction payToPubKeyHash = new PayToPubKeyHash(networkParameters, new File(wallet_name), "password")) {
            DeterministicKey key = payToPubKeyHash.generateVanityAddressMainNet();
            LOGGER.info("Your vanity address key is: ", key);
        } catch (Exception e) {
            e.printStackTrace();
